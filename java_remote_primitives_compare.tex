...
profilers that use both operating system tools and Java language
...
perform better when small to very large objects are transmitted,
whereas XML-RPC exhibits lower response time than sockets with
extremely large bulk data transfers.  The experiments reveal
trade-offs in performance and thus represent the first step towards
determining if Java remote communication primitives can support the
efficient exchange of intra-node messages.
